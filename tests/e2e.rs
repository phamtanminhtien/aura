...
e2e_test!(core_float, "01_core/10_float.aura");
e2e_test!(core_arrays, "01_core/11_arrays.aura");
...
e2e_test!(flow_ternary, "02_control_flow/07_ternary.aura");
...
e2e_test!(oop_generic_interfaces, "04_oop/15_generic_interfaces.aura");
...
e2e_test!(std_collections, "08_stdlib/09_collections.aura");

// --- 11_reexports ---
e2e_test!(reexports_named, "11_reexports/01_named.aura");
