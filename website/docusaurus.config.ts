...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/auraspace/aura/tree/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Aura Project Contributors. Built with Docusaurus.`,
    },
    prism: {
